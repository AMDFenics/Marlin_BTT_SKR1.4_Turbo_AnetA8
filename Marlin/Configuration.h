...
// Author info of this build printed to the host during boot and M115
 #define STRING_CONFIG_H_AUTHOR "(Fenics, BIQU B1)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
   ...
   #define DEFAULT_Kp_LIST {  20.40,  20.40 }
    #define DEFAULT_Ki_LIST {   1.60,   1.60 }
    #define DEFAULT_Kd_LIST { 150.00, 150.00 }
  #else
    #define DEFAULT_Kp  20.40
    #define DEFAULT_Ki   1.60
    #define DEFAULT_Kd 150.00
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 627.80
  #define DEFAULT_bedKi 1.05
  #define DEFAULT_bedKd 565.80
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1300, 1300, 100, 7000 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.070 // (mm) Distance from real junction edge
